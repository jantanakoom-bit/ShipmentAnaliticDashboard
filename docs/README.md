...
| File | Purpose |
|------|---------|
| [mockups/](mockups/) | HTML mockups for all 5 pages (login, dashboard, analytics, shipments, admin) |
...
| `archive/frontend-backend-api-e2e-test-plan.html` | Original test plan HTML; test suite is now in `tests/` and described in project CLAUDE.md |
